...
- **[Remote - SSH](https://aka.ms/vscode-remote/download/ssh)** - Work with source code in any location by opening folders on a remote machine/VM using SSH. Supports x86_64 and ARMv7l (AArch32) glibc-based Linux hosts. [VS Code Insiders](https://code.visualstudio.com/insiders) also supports ARMv8l (AArch64) glibc-based Linux hosts.
...
- x86_64 Alpine Linux containers or WSL distributions (no SSH support yet).
- ARM7l (AArch32) Raspbian Stretch/9+ (32-bit) SSH hosts.
- **Experimental** ([VS Code Insiders only](https://code.visualstudio.com/insiders/)): ARM8l (AArch64) Ubuntu 18.04 (64-bit) SSH hosts.
